/**
 * ARCHITECTURE NOTE: THE DUMB RENDERER
 * 
 * DashboardRenderer is the "Canvas" of the application. It has NO knowledge of 
 * business logic or data fetching. 
 * 
 * Its sole responsibility is to translate the JSON Configuration generated by the 
 * Agent into a valid React Layout. 
 * 
 * By keeping the Renderer "dumb," we make the system highly extensible. To add 
 * a new visualization type, a developer simply adds a React component and 
 * updates the Zod Schema in /lib/genui/schemas.ts.
 */
